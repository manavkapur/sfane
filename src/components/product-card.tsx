  ...
  return (
    ...
    >
      ...
      <Link href={productHref} className="block">
        <div className="relative aspect-square w-full overflow-hidden bg-[radial-gradient(circle_at_18%_18%,rgba(255,255,255,0.95),rgba(245,237,230,0.9)_58%,rgba(241,232,224,0.88))] sm:aspect-[4/5]">
