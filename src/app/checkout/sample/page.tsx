...
export default function CheckoutSamplePage() {
  ...
  const onSubmit = async () => {
    ...
    setSubmitting(false);
    setMessage("Sample flow: next step is Razorpay payment UI.");
  };
  ...
  return (
    <main className="min-h-screen bg-white text-[#1d1d1f]">
      <div className="mx-auto max-w-5xl px-6 pb-24 pt-10">
        ...
        <div className="mt-10 grid gap-10 md:grid-cols-[1.2fr_0.8fr]">
          <section>
            ...
            <div className="mt-16 border-t border-[#d2d2d7] pt-10">
              ...
              <div className="mt-6 grid gap-10 md:grid-cols-[1fr_0.9fr]">
                ...
                <div className="text-sm text-[#6e6e73]">
                  ...
                  <p className="mt-6 font-semibold text-[#1d1d1f]">
                    For a successful delivery, make sure your phone number is correct:
                  </p>
            ...
            <p className="mt-6 text-xs text-[#86868b]">Sample page (no login required).</p>
          </section>
      ...
      <div className="border-t border-[#d2d2d7] bg-[#f5f5f7]">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between gap-4 px-6 py-6 text-sm text-[#1d1d1f]">
          <p>
            Need some help? <a href="#" className="text-[#0066cc] hover:underline">Chat now</a> or call 000800 040 1966.
          </p>
        </div>
      </div>
      ...
      <div className="bg-[#f5f5f7]">
        <div className="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-7">
          <h3 className="text-[52px] font-semibold tracking-tight text-[#1d1d1f] md:text-[56px]">FAQ for Shipping</h3>
          <span className="text-4xl text-[#6e6e73]">⌄</span>
        </div>
      </div>
    </main>
  );
